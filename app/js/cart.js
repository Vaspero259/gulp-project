...
// order processing with localStorage
  ...
  closeOrderForm.onclick = () => orderFormModal.classList.remove('active');
  orderFormModal.onclick = e => { if (e.target === orderFormModal) orderFormModal.classList.remove('active'); };
